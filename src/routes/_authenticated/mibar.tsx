      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
          ...
          <div className="my-6 p-4 rounded-xl bg-albice/10 border border-albice/30 flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground">
                ...
                podés ir eligiendo los partidos que vas a transmitir — la selección queda guardada.
              </p>
            </div>
          </div>
        )}
        ...
        <section className="mt-8">
          ...
          {matchesByDay.length === 0 && (
            <p className="text-sm text-muted-foreground">No hay partidos próximos cargados todavía.</p>
          )}
