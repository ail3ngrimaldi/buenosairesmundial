        ...
        {bar.status === "pending" && (
          <div className="my-6 p-4 rounded-xl bg-albice/10 border border-albice/30 flex items-start gap-3">
            ...
            <div className="text-sm">
              <p className="font-semibold mb-1">Tu bar está en revisión — te avisamos en menos de 24 horas.</p>
        ...
        <section className="mt-8">
          ...
          <div className="space-y-8">
            {matchesByDay.length === 0 && (
              <p className="text-sm text-muted-foreground">No hay próximos partidos cargados todavía.</p>
            )}
